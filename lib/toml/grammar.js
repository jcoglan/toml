        ...
        if (address2) {
          ...
          if (address3) {
            ...
            if (address4) {
              ...
              text0 += address4.textValue;
              var address5 = null;
              var remaining0 = 0, index2 = this._offset, elements1 = [], text1 = "", address6 = true;
              while (address6) {
              ...
              if (remaining0 <= 0) {
                ...
                var klass2 = this.constructor.SyntaxNode;
                var type2 = null;
                address5 = new klass2(text1, this._offset, elements1);
                if (typeof type2 === "object") {
              ...
              if (address5) {
                ...
                address7 = this.__consume__comment();
                if (address7) {
                } else {
                  this._offset = index3;
                ...
                if (address7) {
                  ...
                  address9 = this.__consume__nl();
                  this._offset = index6;
                  if (!(address9)) {
                    var klass4 = this.constructor.SyntaxNode;
                    var type4 = null;
                    address9 = new klass4("", this._offset, []);
                  ...
                  if (address9) {
                    ...
                    if (temp0 === null) {
                      ...
                      var type5 = null;
                      address10 = new klass5(temp0, this._offset, []);
                      if (typeof type5 === "object") {
                        extend(address10, type5);
                      }
                      this._offset += 1;
                    }
                    if (address10) {
                  ...
                  if (elements2) {
                    ...
                    var type6 = null;
                    address8 = new klass6(text2, this._offset, elements2, labelled1);
            ...
            if (address5) {
              ...
              if (address6) {
                ...
                if (address8) {
                  ...
                  var address9 = null;
                  var remaining2 = 0, index4 = this._offset, elements3 = [], text3 = "", address10 = true;
                  while (address10) {
                  ...
                  if (remaining2 <= 0) {
                    ...
                    var klass3 = this.constructor.SyntaxNode;
                    var type3 = null;
                    address9 = new klass3(text3, this._offset, elements3);
                    if (typeof type3 === "object") {
                  ...
                  if (address9) {
                    ...
                    address11 = this.__consume__comment();
                    if (address11) {
                    } else {
                      this._offset = index5;
                      var klass4 = this.constructor.SyntaxNode;
                    ...
                    if (address11) {
                      ...
                      var address12 = null;
                      var index6 = this._offset;
                      var index7 = this._offset, elements4 = [], labelled1 = {}, text4 = "";
                      var address13 = null;
                      var index8 = this._offset;
                      address13 = this.__consume__nl();
                      this._offset = index8;
                      if (!(address13)) {
                        var klass5 = this.constructor.SyntaxNode;
                        var type5 = null;
                        address13 = new klass5("", this._offset, []);
                        if (typeof type5 === "object") {
                          extend(address13, type5);
                        }
                        this._offset += 0;
                      } else {
                        address13 = null;
                      ...
                      if (address13) {
                        ...
                        if (temp0 === null) {
                          ...
                          var klass6 = this.constructor.SyntaxNode;
                          var type6 = null;
                          address14 = new klass6(temp0, this._offset, []);
                          if (typeof type6 === "object") {
                      ...
                      if (elements4) {
                        ...
                        var klass7 = this.constructor.SyntaxNode;
                        var type7 = null;
                        address12 = new klass7(text4, this._offset, elements4, labelled1);
                        if (typeof type7 === "object") {
                      ...
                      if (!(address12)) {
                        var klass8 = this.constructor.SyntaxNode;
                        var type8 = null;
                        address12 = new klass8("", this._offset, []);
                        if (typeof type8 === "object") {
                          extend(address12, type8);
                        }
                        this._offset += 0;
                      } else {
                        address12 = null;
