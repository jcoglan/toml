  ...
  var Grammar = {
            ...
            if (address4) {
              ...
              if (address5) {
                ...
                if (address7) {
                  ...
                  var address8 = null;
                  address8 = this.__consume__nl();
                  if (address8) {
                    elements0.push(address8);
                    text0 += address8.textValue;
                    labelled0.nl = address8;
                  } else {
                    elements0 = null;
                    this._offset = index1;
                  }
                ...
                if (address8) {
                  ...
                  if (address9) {
                    ...
                    if (address11) {
                      ...
                      var address12 = null;
                      address12 = this.__consume__nl();
                      if (address12) {
                        elements0.push(address12);
                        text0 += address12.textValue;
                        labelled0.nl = address12;
                      } else {
                        elements0 = null;
                        this._offset = index1;
                      }
    ...
    __consume__datetime: function(input) {
                        ...
                        if (address22) {
                          ...
                          if (address23) {
                            ...
                            if (slice38 === "Z") {
                              ...
                              var type25 = null;
                              address26 = new klass25("Z", this._offset, []);
                              if (typeof type25 === "object") {
                                extend(address26, type25);
                              }
                              this._offset += 1;
                            } else {
                              address26 = null;
      ...
      if (elements0) {
        ...
        var type26 = find(this.constructor, "Datetime");
        address0 = new klass26(text0, this._offset, elements0, labelled0);
        if (typeof type26 === "object") {
          extend(address0, type26);
        }
        this._offset += text0.length;
      } else {
        address0 = null;
      ...
      if (address0) {
        ...
        if (address0) {
          ...
          if (slice4 === "\r") {
            var klass2 = this.constructor.SyntaxNode;
            var type2 = null;
            address0 = new klass2("\r", this._offset, []);
            if (typeof type2 === "object") {
              extend(address0, type2);
            }
            this._offset += 1;
